...
namespace DNA.Data.Units
{
	...
	public struct Length
	{
		...
		public float Miles
		{
			get
			{
				return this._meters * 0.0006213712f;
			}
		}

		public override int GetHashCode()
		{
			return this._meters.GetHashCode();
		}

		public override bool Equals(object obj)
		{
			return this._meters == ((Length)obj)._meters;
		}
		...
		{
			return Length.FromMeters(m1.Meters + m2.Meters);
		}

		public static Length operator *(Length m1, float c)
		{
			return Length.FromMeters(m1.Meters * c);
		}
		...
		{
			return (double)(m1.Meters / m2.Meters);
		}
