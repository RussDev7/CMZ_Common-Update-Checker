...
namespace DNA.Drawing
{
	public class Sprite
	{
		...
		{
			Rectangle destRect = new Rectangle((int)position.X, (int)position.Y, (int)((float)this._sourceRectangle.Width * scale), (int)((float)this._sourceRectangle.Height * scale));
			batch.Draw(this._texture, destRect, new Rectangle?(this._sourceRectangle), color, 0f, Vector2.Zero, effects, 1f);
		}

		public void Draw(SpriteBatch batch, Rectangle destinationRectangle, Rectangle sourceRectangle, Color color)
		{
			Rectangle adjSrect = new Rectangle(sourceRectangle.Left + this._sourceRectangle.Left, sourceRectangle.Top + this._sourceRectangle.Top, sourceRectangle.Width, sourceRectangle.Height);
			batch.Draw(this._texture, destinationRectangle, new Rectangle?(adjSrect), color);
		}
		...
		{
			Rectangle adjSrect = new Rectangle(sourceRectangle.Left + this._sourceRectangle.Left, sourceRectangle.Top + this._sourceRectangle.Top, sourceRectangle.Width, sourceRectangle.Height);
			batch.Draw(this._texture, destinationRectangle, new Rectangle?(adjSrect), color, rotation.Radians, origin, effects, layerDepth);
		}
		...
		{
			Rectangle adjSrect = new Rectangle(sourceRectangle.Left + this._sourceRectangle.Left, sourceRectangle.Top + this._sourceRectangle.Top, sourceRectangle.Width, sourceRectangle.Height);
			batch.Draw(this._texture, position, new Rectangle?(adjSrect), color, rotation.Radians, origin, scale, effects, layerDepth);
		}
