...
{
	public class KeyboardInputScreen : DialogScreen
	{
		...
		public KeyboardInputScreen(DNAGame game, string title, string description, Texture2D bgImage, SpriteFont font, bool drawBehind)
			: base(title, description, null, true, bgImage, font, drawBehind)
		{
			this.TitlePadding = new Vector2(55f, 15f);
			this.DescriptionPadding = new Vector2(25f, 35f);
			this.ButtonsPadding = new Vector2(25f, 20f);
			this._game = game;
		}

		public KeyboardInputScreen(DNAGame game, string title, string description1, string description2, Texture2D bgImage, SpriteFont font, bool drawBehind)
			: base(title, description1, null, true, bgImage, font, drawBehind)
		{
			this.TitlePadding = new Vector2(55f, 15f);
			this.DescriptionPadding = new Vector2(25f, 35f);
			this.ButtonsPadding = new Vector2(25f, 20f);
		...
		public KeyboardInputScreen(DNAGame game, string title, string description1, string description2, string description3, Texture2D bgImage, SpriteFont font, bool drawBehind)
			: base(title, description1, null, true, bgImage, font, drawBehind)
		{
			this.TitlePadding = new Vector2(55f, 15f);
			this.DescriptionPadding = new Vector2(25f, 35f);
