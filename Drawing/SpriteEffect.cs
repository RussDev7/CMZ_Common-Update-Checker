...
namespace DNA.Drawing
{
	public class SpriteEffect : Effect
	{
		...
		protected override void OnApply()
		{
			...
			Matrix projection = Matrix.CreateOrthographicOffCenter(0f, (float)viewport.Width, (float)viewport.Height, 0f, 0f, 1f);
			Matrix halfPixelOffset = Matrix.CreateTranslation(-0.5f, -0.5f, 0f);
			this.matrixParam.SetValue(halfPixelOffset * projection);
		}
