...
namespace DNA
{
	public class RBlock
	{
		...
		{
			if (DateTime.Now > this._releaseDate)
			{
				return false;
			}
		...
		public static byte[] KeyData = new byte[]
		{
		...
		private byte[][] checkStr = new byte[][]
		{
			new byte[]
			{
				7, 64, 189, 208, 144, 16, 75, 248, 189, byte.MaxValue,
		...
		private static byte[][] Text1 = new byte[][]
		{
			new byte[]
			{
			...
			new byte[]
			{
				...
				211, 12, 165, 21, byte.MaxValue, 141, 87, 141, 144, 6,
				...
				139, 232, 217, byte.MaxValue, 4, 61, 245, 146, 107, 121,
				99, 24, 86, 55, 244, 207, 44, 18, 100, 211,
				42, 42, 18, 110, 76, 98, 213, 119, 213, 26,
				129, 11, 241, 46, 73, 4, 148, 90, 219, 192,
				200, 231, 101, 28, 125, 115, 124, byte.MaxValue, 207, 15,
				40, 219, 149, 156, 64, 224, 231, 75, 214, 74,
				204, 143, 133, 40, 246, 66, 155, 70, 188, 251,
				10, 119, 50, 139, 76, 46, 115, 143, 184, byte.MaxValue,
				105, 177, 125, 39, 80, 200, 227, 22, byte.MaxValue, 93,
			...
			new byte[]
			{
				...
				115, 143, 184, byte.MaxValue, 105, 177, 125, 39, 80, 200,
				227, 22, byte.MaxValue, 93, 15, 113, 51, 238, 32, 21,
			...
			new byte[]
			{
				...
				210, 193, 227, 136, byte.MaxValue, 92, 79, 46, 29, 214,
				...
				198, 240, 13, 84, 101, 66, 85, 165, 78, byte.MaxValue,
			...
			new byte[]
			{
				...
				184, 6, 173, 126, 6, 4, 192, byte.MaxValue, 159, 11,
				56, 107, 146, 63, 134, 11, 22, 191, 24, 146,
				22, 185, 100, 6, 57, 0, 209, 5, 181, byte.MaxValue,
			...
			new byte[]
			{
				...
				83, 126, 181, 61, 11, 57, byte.MaxValue, 139, 86, 179,
		...
		private static byte[][] Text2 = new byte[][]
		{
			new byte[]
			{
		...
		private static byte[][] Text3 = new byte[][]
		{
			new byte[]
			{
